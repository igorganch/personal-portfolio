...
import { Container, Row, Col, Card, Table, Carousel, Button} from 'react-bootstrap';
...
function App() {
  ...
  const [projects, projectSets]  = useState([
      {'name' : 'E-commerce Website', 'video' : grocerrystorevid,  'live' : true , 'github' : "https://github.com/igorganch/Groccery-Store-Website" ,  'liveurl' : "https://grocerystoreiharproject.herokuapp.com/",   'desc'  : "This project is an e-commerce grocery store developed using Django framework and storing data using PostgreSQL. In this app you're able to browse through the websites products as well as add items to carts and do guest checkout. " },
      ...
      {'name' : 'Dealership API', 'video' : dealershipAPI,  'live' : true , 'github' : "https://github.com/igorganch/dealershipAPI" ,'liveurl' : "https://dealershipapi1.herokuapp.com/", 'desc'  : "This is a simple web app API coded using Node.js,Express, & html which retrieves data from database system using PostgreSQL. In this web app you are able to do CRUD(Create,Retreive,Update & Delete) operations between the server and the database." },
      ...
      {'name' : 'Inventory Manager', 'video' : '/url',  'live' : false ,'github' : "https://github.com/igorganch/Inventory-Manager" ,  'liveurl' : "", 'desc'  : "This app serves a purpose of keeping track of orders, inventory, and items sold. The app has many features incorporated in order to help a business to run fluently and organized. This program demonstrates the use of OOP with inheritance using dynamic memory, File streams which saves the data every time the program is exited." },
