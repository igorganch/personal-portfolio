...
function App() {
  ...
  const [projects, projectSets]  = useState([
      {'name' : 'EduTechnoz', 'video' : EduTechnoz,  'live' : false , 'tools' : ['React' ,'JavaScript', 'HTML5', 'CSS'], 'github' : "https://www.igancharenka.com/" ,  'liveurl' : "https://sample.edutechnoz.com/",   'desc'  : "A series of pages for a kids educational company I had to create during my internship in Kiuloper. It is responsive on every device." },
      {'name' : 'Music Management App', 'video' : MusicManagementApp,  'live' : false , 'tools' : ['ASP.NET', 'MVC', 'Azure', 'HTML5' ,'CSS',], 'github' : "https://github.com/igorganch/MusicManagementWebApp" ,  'liveurl' : "https://musicmanagement-wa.azurewebsites.net/",   'desc'  : "An app where users based on privileges are able to add/edit/delete/view  tracks, albums, artists all on one website. The app implements security concepts.  " },
      {'name' : 'Dealership API', 'video' : dealershipAPI,  'live' : true ,'tools' : ['Node.js' , 'JavaScript', 'Express.js', 'HTML5'], 'github' : "https://github.com/igorganch/dealershipAPI" ,'liveurl' : "https://dealership-db.herokuapp.com/", 'desc'  : "A web app API which retrieves data from a database and a user is able to perform CRUD operations" },
      ...
      {'name' : 'Computer Graphics 4 cubes', 'video' : threedvid,  'live' : false ,'tools' : ['C++' , 'OpenGL'], 'github' : "https://github.com/igorganch/3DGraphics" ,  'liveurl' : "", 'desc'  : "This openGL app loads 4 cubes, where the user can assign different textures to the cubes as well as differrent transformations. " },
