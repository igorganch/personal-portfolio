...
function App() {
  ...
  const [projects, projectSets]  = useState([
      ...
      {'name' : 'E-commerce Website', 'video' : grocerrystorevid,  'live' : false , 'tools' : ['Django' ,'Python' ,'JavaScript', 'JQuery', 'PostgreSQL','HTML5', 'CSS', 'Bootstrap'], 'github' : "https://github.com/igorganch/Groccery-Store-Website" ,  'liveurl' : "",   'desc'  : "An e-commerce grocery store where a use is  able to browse through the websites products as well as add items to carts and do guest checkout. " },  
