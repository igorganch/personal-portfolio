...
function App() {
  ...
  const [projects, projectSets]  = useState([
      ...
      {'name' : 'Dealership API', 'video' : dealershipAPI, 'githubLink' : true, 'live' : true ,'tools' : ['Node.js' , 'JavaScript', 'Express.js', 'HTML5'], 'github' : "https://github.com/igorganch/dealershipAPI" ,'liveurl' : "https://dealership-db.herokuapp.com/", 'desc'  : "A web app API which retrieves data from a database and a user is able to perform CRUD operations" },
