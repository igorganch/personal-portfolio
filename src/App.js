...
function App() {
  ...
  const [projects, projectSets]  = useState([
      ...
      {'name' : 'EduTechnoz', 'video' : EduTechnoz,  'live' : true , 'tools' : ['React' ,'JavaScript', 'HTML5', 'CSS'], 'github' : "" ,  'liveurl' : "https://sample.edutechnoz.com/",   'desc'  : "A series of pages for a kids educational company during my internship in Kiuloper. It is responsive on every device." },
