...
function Skills(props) {
  ...
  const [skills, skillsSets] = useState([
    ...
    { 'name'  : "CSS"  , 'image'   : css, "category" : frontEnd, "experience" : "4 Year Experience" },
    { 'name'  : "JQuery"  , 'image'   : jq, "category" : frontEnd, "experience" : "4 Year Experience" },
    { 'name'  : "HTML5"  , 'image'   : hmtl, "category" : frontEnd, "experience" : "4 Year Experience" },
    { 'name'  : "Bootstrap"  , 'image'   : bootstrappng, "category" : frontEnd, "experience" : "4 Year Experience" },
    { 'name'  : "C++"  , 'image'   : cplusspluss, "category" : fullStack, "experience" : "4 Year Experience" },
    ...
    { 'name'  : "Java"  , 'image'   : java, "category" :  fullStack, "experience" : "3 Year Experience"},
    { 'name'  : "node.js"  , 'image'   : nodejs, "category" : backEnd, "experience" : "4 Year Experience" },
    { 'name'  : "Express.js"  , 'image'   : express, "category" : backEnd, "experience" : "4 Year Experience" },
    { 'name'  : "Spring Boot"  , 'image'   : springboot , "category" : backEnd, "experience" : "1 Year Experience" },
    { 'name'  : "SQL"  , 'image'   : sql, "category" : other , "experience" : "4 Year Experience"},
    { 'name'  : "MongoDB"  , 'image'   : mongo, "category" : other, "experience" : "3 Year Experience" },
    { 'name'  : "PostgreSQL"  , 'image'   : postgresql, "category" : other, "experience" : "4 Year Experience" },
...
function App() {
  ...
  const [projects, projectSets]  = useState([
      {'name' : 'EduTechnoz', 'video' : EduTechnoz, 'githubLink' : false,  'live' : true , 'tools' : ['React' ,'JavaScript', 'HTML5', 'CSS'], 'github' : "https://www.igancharenka.com/" ,  'liveurl' : "https://sample.edutechnoz.com/",   'desc'  : "A series of pages for a kids educational company I had to create during my internship in Kiuloper. It is responsive on every device." },
      {'name' : 'Music Management App', 'video' : MusicManagementApp, 'githubLink' : true, 'live' : false , 'tools' : ['ASP.NET', 'MVC', 'Azure', 'HTML5' ,'CSS',], 'github' : "https://github.com/igorganch/MusicManagementWebApp" ,  'liveurl' : "https://musicmanagement-wa.azurewebsites.net/",   'desc'  : "An app where users based on privileges are able to add/edit/delete/view  tracks, albums, artists all on one website. The app implements security concepts.  " },
      {'name' : 'Dealership API', 'video' : dealershipAPI, 'githubLink' : true, 'live' : false ,'tools' : ['Node.js' , 'JavaScript', 'Express.js', 'HTML5'], 'github' : "https://github.com/igorganch/dealershipAPI" ,'liveurl' : "https://dealership-db.herokuapp.com/", 'desc'  : "A web app API which retrieves data from a database and a user is able to perform CRUD operations" },
      {'name' : 'Mobile Cashier App', 'video' : cashierApp, 'githubLink' : true,  'live' : true , 'tools' : ['Angular' , 'HTML', 'OOP', 'CSS'],'github' : "https://github.com/igorganch/Angular-Cashier-App" , 'liveurl' : "https://heuristic-shannon-eaaa58.netlify.app/", 'desc'  : "An Angular Ionic mobile app that acts as a cash register which manages restocking, purchases, and purchase histories." },
      {'name' : 'E-commerce Website', 'video' : grocerrystorevid, 'githubLink' : true, 'live' : false , 'tools' : ['Django' ,'Python' ,'JavaScript', 'JQuery', 'PostgreSQL','HTML5', 'CSS', 'Bootstrap'], 'github' : "https://github.com/igorganch/Groccery-Store-Website" ,  'liveurl' : "",   'desc'  : "An e-commerce grocery store website where a user is able to browse through the website's products as well as add items to carts and do guest checkout." },  
      {'name' : 'Inventory Manager', 'video' : invvid,  'githubLink' : true, 'live' : false ,'tools' : ['C++' , 'OOP'],'github' : "https://github.com/igorganch/Inventory-Manager" ,  'liveurl' : "", 'desc'  : "This app serves a purpose of keeping track of orders, inventory, and items sold." },
      {'name' : 'Mobile Cashier App C#', 'video' : cashc, 'githubLink' : true,  'live' : false , 'tools' : ['C#' , 'OOP', 'Xamrin.Forms'], 'github' : "https://github.com/igorganch/CashierApp" ,  'liveurl' : "", 'desc'  : "A mobile app that acts as a cash register which keeps track of items sold and allows the user to restock items." },
      {'name' : 'Computer Graphics 4 cubes', 'video' : threedvid, 'githubLink' : true,  'live' : false ,'tools' : ['C++' , 'OpenGL'], 'github' : "https://github.com/igorganch/3DGraphics" ,  'liveurl' : "", 'desc'  : "This openGL app loads 4 cubes, where the user can assign different textures to the cubes as well as differrent transformations. " },
      {'name' : 'Hangman', 'video' : hangman, 'githubLink' : true,  'live' : false ,'tools' : ['Python' , 'OOP', 'MongoDB'], 'github' : "https://github.com/igorganch/Hangman" ,  'liveurl' : "", 'desc'  : "This is a simple game of hangman created using python which saves all the scores players have scored to the database." }     ,
      {'name' : 'Computer Graphics 10 cubes', 'video' : tencubes,  'githubLink' : true, 'live' : false ,'tools' : ['C++' , 'OpenGL'], 'github' : "https://github.com/igorganch/OpenGL10SquaresPerspective" ,  'liveurl' : "", 'desc'  : "This openGL app generates 10 squares, where you can change the camera perspective by zooming in/out and shifting the view from left and right." },
      {'name' : 'Connect 4', 'video' : '/url', 'video' : null, 'githubLink' : true, 'live' : false ,'tools' : ['Java' , 'JavaFX', 'OOP'],'github' : "https://github.com/igorganch/Connect4" ,  'liveurl' : "", 'desc'  : "A 2 Player classic game of connect 4, in order to win a player must a-line 4 of their own red/yellow coloured circles either diagonally, horizontally or vertically." },
            ...
            {projects.map((project) => 
                ...
                <video variant="top" loop onMouseOver={e => e.target.play()} onMouseLeave={e => e.target.pause()}  src={project.video}/>
                  ...
                  <div className ="extras">
                    ...
                    {project.githubLink ? ( <a href = {project.github}><Button className = "githubButton" variant="primary"><img className = "gitButton" src={github}/></Button></a>) : (null)}
                    </div>
                    </div>
